...
In Donny Tr??ng's Master's thesis on Vietnamese Typography, there is a chapter that discusses some of the challenges in designing fonts that support Vietnamese. But from the perspective of a "font user", reading it can help one gain many experiences in choosing a good font. 

Some points that the paper points out that we can use as criteria for evaluating the fonts include:

- The position of tone marks for different characters should be in the same direction, especially tone marks that accompany vowels like ? ? ? ? ? ? ? ? ?. This element is important because uniform positioning helps with a reader's flow, making it easier to read and avoiding interruptions in the eye's scanning flow. 
...
- Vowels with accents must have the accent mark in the same position, not slanted. For example, ? ? ? ? â ô Â Ô.
...
For more information, I recommend reading entire thesis of the author Donny Tr??ng. 
...
- Vietnamese has many pairs of letter that when placed side by side, are very difficult to read when making a typeface with a heavy weight like black or heavy. For example, the font Roboto Black has the letters Tì / T? that are very difficult to see because the ~ overlaps with the T. 
- Also because of the syllables and tone marks in Vietnamese, kerning spacing for fonts is also very difficult. For example, if using IBM Plex Sans, people will see that the spacing between letters Ti or WA looks pleasing to the eye, but when applied to Vietnanese and kerned with a font like that, the letters T? / T? look very uncomfortable.
...
Tã and T?u is the unit test of font design in Vietnamese :laughing:
...
Fun fact: Donny Tr??ng là advisor c?a Inter on Vietnamese :adore: that’s why: https://twitter.com/_thiendo/status/1403915963326627840?s=46&t=HgJF1UeHuJod_aB7tIpYBg
